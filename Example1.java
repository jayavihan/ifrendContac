...
class Example1{
   ...
   // public static customer[] customerArray=new customer [0];
    ...
    public static String generateId(){
		if(contactArray.nextIndex==0){
			return "C0001";
		}
		String lastId=contactArray.contactArray[contactArray.nextIndex-1].getid();
   ...
   /* public static void extendArrays(){ 
    ...
    public static void addContacts(){
        ...
        do{
            ...
            //contactArray[contactArrays.nextIndex]=cus;
            contactArray.add(cus);
    ...
    public static void printDetails(int index){
        System.out.println("Contact Id : "+contactArray.contactArray[index].getid());
        System.out.println("Name : "+contactArray.contactArray[index].getname());
        System.out.println("Phone Number : "+contactArray.contactArray[index].getphoneNumber());
        System.out.println("Company Name : "+contactArray.contactArray[index].getcompanyName());
        System.out.println("Salary : "+contactArray.contactArray[index].getsalary());
        System.out.println("Birthday : "+contactArray.contactArray[index].getbirthday());
    }
    //--------------------------SEARCH CONTACT-------------------------
    ...
    public static void updateName(int index){
        ...
        contactArray.contactArray[index].setname(newName);
    }
    //--------------------------UPDATE NAME----------------------------
    public static void updatePhoneNumber(int index){
        ...
        contactArray.contactArray[index].setphoneNumber(newPhoneNumber);
    }
    //--------------------------UPDATE NAME----------------------------
    public static void updateCompanyName(int index){
        ...
        contactArray.contactArray[index].setcompanyName(newCompanyName);
    }
    //--------------------------UPDATE NAME----------------------------
    public static void updateSalary(int index){
        ...
        contactArray.contactArray[index].setsalary(newSalary);
    }
    //--------------------------UPDATE CONTACTS-----------------------
    ...
    public static void sortByBirthday(){
        ...
        do{
            ...
            contactArray.sortingByBirthday();
